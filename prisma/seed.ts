...
// ============================================================================
// PROFESSION SEED DATA
// ============================================================================

const PROFESSION_CATEGORIES: Array<{ nameHe: string; professions: string[] }> = [
  {
    nameHe: 'בריאות',
    professions: [
      'רופא/ה', 'אחות/ת מוסמכת/ת', 'פיזיותרפיסט/ית', 'מטפל/ת רגשי/ת', 'פסיכולוג/ית',
      'רוקח/ת', 'רופא/ת שיניים', 'היגיניסטית שיניים', 'אופטומטריסט/ית', 'דיאטן/ית קליני/ת',
      'מטפל/ת ברפואה משלימה', 'מטפל/ת בעיסוי', 'עובד/ת סוציאלי/ת', 'יועצת הנקה', 'מיילדת',
      'פסיכיאטר/ית', 'נוירולוג/ית', 'אונקולוג/ית',
    ],
  },
  {
    nameHe: 'חינוך',
    professions: [
      'מורה לגיל הרך', 'מורה בבית ספר יסודי', 'מורה בחטיבה', 'מורה בתיכון', 'גננת',
      'סייעת', 'מנהל/ת בית ספר', 'יועצ/ת חינוכי/ת', 'מורה למתמטיקה', 'מורה לאנגלית',
      'מורה למוסיקה', 'מורה לחינוך גופני', 'מורה להוראה מתקנת', 'מורה פרטי/ת', 'מנחה חוגים',
      'מדריכ/ת נוער', 'פסיכולוג/ית חינוכי/ת',
    ],
  },
  {
    nameHe: 'היי-טק',
    professions: [
      'מהנדס/ת תוכנה', 'מפתח/ת פרונט-אנד', 'מפתח/ת בק-אנד', 'מפתח/ת פולסטאק', 'מנהל/ת מוצר',
      'מעצב/ת UX/UI', 'QA', 'DevOps', 'מהנדס/ת AI/ML', 'מדען/ית נתונים',
      'מנתח/ת מערכות', 'אבטחת מידע', 'מנהל/ת פרויקטים טכנולוגיים', 'סקראם מאסטר', 'CTO',
      'ארכיטקט/ית תוכנה', 'מנהל/ת R&D',
    ],
  },
  {
    nameHe: 'פיננסים',
    professions: [
      'רואה/ת חשבון', 'יועצ/ת מס', 'מנהל/ת חשבונות', 'יועצ/ת השקעות', 'יועצ/ת פנסיוני/ת',
      'סוכנ/ת ביטוח', 'יועצ/ת משכנתאות', 'בנקאי/ת', 'מנהל/ת כספים', 'אנליסט/ית פיננסי/ת',
      'יועצ/ת כלכלי/ת', 'מנהל/ת קרן', 'אקטואר/ית',
    ],
  },
  {
    nameHe: 'משפט',
    professions: [
      'עורכ/ת דין', 'נוטריון/ית', 'מגשר/ת', 'יועצ/ת משפטי/ת', 'שופט/ת',
      'עורכ/ת דין פלילי/ת', 'עורכ/ת דין נדל"ן', 'עורכ/ת דין עבודה', 'עורכ/ת דין חברות',
      'בורר/ת', 'כונס/ת נכסים', 'חוקר/ת פרטי/ת משפטי/ת', 'סניגור/ית ציבורי/ת',
      'פרקליט/ה', 'עורכ/ת דין קניין רוחני',
    ],
  },
  {
    nameHe: 'אומנות ויצירה',
    professions: [
      'צייר/ת', 'פסל/ת', 'צלמ/ת', 'מעצב/ת גרפי/ת', 'מעצב/ת אופנה',
      'מעצב/ת תכשיטים', 'סופר/ת', 'משורר/ת', 'שחקנ/ית', 'במאי/ת',
      'מוזיקאי/ת', 'נגנ/ית', 'זמר/ת', 'רקדנ/ית', 'יוצר/ת תוכן',
      'אמנ/ית קעקועים', 'קרמיקאי/ת',
    ],
  },
  {
    nameHe: 'תקשורת ומדיה',
    professions: [
      'עיתונאי/ת', 'עורכ/ת תוכן', 'מנהל/ת רשתות חברתיות', 'יחצנ/ית', 'צלמ/ת וידאו',
      'עורכ/ת וידאו', 'פודקאסטר/ית', 'מנחה רדיו', 'קופירייטר/ית', 'מתרגמ/ת',
      'מנחה תוכניות', 'כתב/ת', 'צלמ/ת סטילס', 'מנהל/ת מותג', 'דובר/ת',
    ],
  },
  {
    nameHe: 'הנדסה',
    professions: [
      'מהנדס/ת חשמל', 'מהנדס/ת מכונות', 'מהנדס/ת אזרחי/ת', 'מהנדס/ת כימי/ת', 'מהנדס/ת תעשייה וניהול',
      'אדריכל/ית', 'אדריכל/ית נוף', 'מודד/ת', 'יועצ/ת אקוסטיקה', 'יועצ/ת בטיחות',
      'מהנדס/ת אלקטרוניקה', 'מהנדס/ת מים', 'מהנדס/ת סביבה', 'מהנדס/ת ביו-רפואי/ת',
      'מהנדס/ת אופטיקה', 'מהנדס/ת פרויקטים',
    ],
  },
  {
    nameHe: 'בנייה ושיפוצים',
    professions: [
      'קבלן/ית בניין', 'חשמלאי/ת', 'אינסטלטור/ית', 'צבע/ית', 'רצף/ית',
      'נגר/ת', 'גגן/ית', 'אלומיניומאי/ת', 'מסגר/ת', 'מתקינ/ת מזגנים',
      'מתקינ/ת מערכות סולאריות', 'פועל/ת בניין', 'שיפוצניק/ית', 'טכנאי/ת קרמיקה',
      'מנהל/ת עבודה בנייה',
    ],
  },
  {
    ...
    professions: [
      'נהג/ת אוטובוס', 'נהג/ת משאית', 'נהג/ת מונית', 'מורה נהיגה', 'חבר/ת צוות אוויר',
      'טכנאי/ת רכב', 'מכונאי/ת', 'מנהל/ת מחסן', 'מתאמ/ת לוגיסטיקה', 'שליח/ה',
      'מנהל/ת שרשרת אספקה', 'פיילוט/ית', 'קברניט/ית ספינה', 'מנהל/ת נמל',
    ],
  },
  {
    nameHe: 'מזון ומסעדנות',
    professions: [
      'שף/ית', 'טבח/ית', 'אופה/ית', 'קונדיטור/ית', 'ברמן/ית',
      'מלצר/ית', 'בעל/ת מסעדה', 'יועצ/ת תזונה', 'קייטרינג', 'יצרנ/ית מאפים ביתיים',
      'סומלייה', 'טכנולוג/ית מזון', 'מנהל/ת מסעדה', 'מארחת',
    ],
  },
  {
    nameHe: 'יופי וטיפוח',
    professions: [
      'ספר/ית', 'מאפר/ת', 'קוסמטיקאי/ת', 'מעצב/ת ציפורניים', 'מעצב/ת גבות וריסים',
      'פדיקוריסט/ית', 'מטפל/ת ברפלקסולוגיה', 'מעסה רפואי/ת', 'מטפל/ת בעור',
      'יועצ/ת אופנה', 'מעצב/ת שיער', 'מדריכ/ת אסתטיקה',
    ],
  },
  {
    nameHe: 'ספורט ופנאי',
    professions: [
      'מאמנ/ת כושר אישי/ת', 'מורה ליוגה', 'מורה לפילאטיס', 'מאמנ/ת ילדים', 'מאמנ/ת קבוצה',
      'מורה לשחייה', 'מציל/ה', 'מדריכ/ת טיולים', 'ספורטאי/ת מקצועי/ת', 'כדורגלן/ית',
      'שופט/ת ספורט', 'מנהל/ת מתחם ספורט', 'מדריכ/ת אומנויות לחימה', 'מנהל/ת מחנות קיץ',
    ],
  },
  {
    nameHe: 'ביטחון וחירום',
    professions: [
      'שוטר/ת', 'חייל/ת בשירות קבע', 'כבאי/ת', 'פראמדיק/ית', 'חובש/ת',
      'מאבטח/ת', 'חוקר/ת פרטי/ת', 'קצינ/ת מודיעין', 'מפקד/ת', 'לוחמ/ת אש',
      'מנהל/ת חירום', 'קצינ/ת ביטחון', 'מציל/ת חוף', 'כונ/ת חירום',
    ],
  },
  {
    nameHe: 'חקלאות וטבע',
    professions: [
      'חקלאי/ת', 'גנן/ית', 'מטפח/ת צמחים', 'וטרינר/ית', 'מטפל/ת בבעלי חיים',
      'מאלפ/ת כלבים', 'דבורן/ית', 'מאמנ/ת סוסים', 'מנהל/ת חווה', 'פקח/ת שמורות טבע',
      'אגרונום/ית', 'מהנדס/ת חקלאי/ת', 'יועצ/ת סביבתי/ת', 'מגדל/ת דגים',
    ],
  },
  {
    nameHe: 'שירותים ומסחר',
    professions: [
      'בעל/ת חנות', 'מוכר/ת', 'נציג/ת שירות לקוחות', 'מנהל/ת קמעונאות', 'יבואנ/ית',
      'סוכנ/ת מכירות', 'מתווכ/ת נדל"ן', 'איש/אשת קשר', 'מנהל/ת מכירות', 'קניין/ית',
      'מנהל/ת חנות אונליין', 'איש/אשת שטח', 'מנהל/ת לקוחות', 'ספק/ית שירותים',
    ],
  },
  {
    nameHe: 'ניהול ומשאבי אנוש',
    professions: [
      'מנהל/ת כללי/ת', 'מנהל/ת תפעול', 'מנהל/ת משאבי אנוש', 'מגייס/ת', 'מאמנ/ת אישי/ת',
      'יועצ/ת ארגוני/ת', 'מנהל/ת שיווק', 'CEO', 'CFO', 'COO',
      'מנהל/ת פיתוח עסקי', 'מנהל/ת לוגיסטיקה', 'מנהל/ת רכש', 'מנהל/ת אסטרטגיה',
    ],
  },
  {
    nameHe: 'דת ורוחניות',
    professions: [
      'רב', 'רב קהילה', 'רב בית כנסת', 'דיין', 'ראש כולל',
      'ראש ישיבה', 'מגיד שיעור', 'מלמד תינוקות', 'משגיח/ת כשרות',
      'מוהל', 'שוחט', 'סופר סת"ם', 'יועצ/ת הלכה', 'גבאי בית כנסת',
      'חזן', 'מורה הוראה', 'מדריכ/ת חתנים', 'מדריכ/ת כלות',
      'יועצ/ת טהרת המשפחה', 'מנהל/ת בית כנסת', 'מנהל/ת מקווה',
    ],
  },
  {
    nameHe: 'מדע ומחקר',
    professions: [
      'חוקר/ת אקדמי/ת', 'פרופ/ית באוניברסיטה', 'דוקטור/נטית', 'מרצה',
      'ביולוג/ית', 'כימאי/ת', 'פיזיקאי/ת', 'מתמטיקאי/ת', 'סטטיסטיקאי/ת',
      'גיאולוג/ית', 'אסטרונום/ית', 'חוקר/ת שוק', 'חוקר/ת מדיניות',
      'מהנדס/ת מחקר', 'לבורנט/ית',
    ],
  },
  {
    nameHe: 'עיצוב ואדריכלות פנים',
    professions: [
      'מעצב/ת פנים', 'אדריכל/ית פנים', 'יועצ/ת תאורה', 'יועצ/ת מטבחים',
      'יועצ/ת ארגון בית', 'הום סטיילינג', 'מתכננ/ת מטבחים',
      'מעצב/ת אירועים', 'סטייליסט/ית בית',
    ],
  },
  {
    nameHe: 'גיל הרך וטיפול בילדים',
    professions: [
      'מטפל/ת בילדים', 'מטפל/ת בית בילדים', 'בייביסיטר/ית', 'אומנת',
      'מטפל/ת לידה (דולה)', 'מטפל/ת אחרי לידה', 'מטפל/ת ברפואת תינוקות',
      'יועצ/ת שינה לתינוקות', 'בעל/ת משפחתון', 'מורה לחוגים לילדים',
    ],
  },
  {
    nameHe: 'תיירות והכנסת אורחים',
    professions: [
      'מדריכ/ת תיירים', 'מורה דרך', 'סוכנ/ת נסיעות', 'מנהל/ת מלון',
      'פקיד/ת קבלה במלון', 'בעל/ת צימר/אכסניה', 'מארגנ/ת אירועים',
      'מנהל/ת אירועים', 'מנחה אירועים',
    ],
  },
  {
    nameHe: 'מלאכות יד וקרפט',
    professions: [
      'נגר/ת', 'מסגר/ת', 'נפח/ית', 'תופר/ת', 'תופר/ת בגדים',
      'תופר/ת ריפוד', 'סנדלר/ית', 'שעונאי/ת', 'צורף/ת',
      'מאלף/ת זכוכית', 'אורג/ת', 'סורג/ת', 'קרמיקאי/ת', 'יוצר/ת תכשיטים',
    ],
  },
  {
    nameHe: 'רכב ותחבורה אישית',
    professions: [
      'מכונאי/ת רכב', 'חשמלאי/ת רכב', 'פחח/ית רכב', 'צבע/ית רכב',
      'בודק/ת רכב', 'שמאי/ת רכב', 'מתקין/ת מערכות אזעקה לרכב',
      'מתקין/ת רדיו ומולטימדיה לרכב', 'מנהל/ת מוסך', 'מתקין/ת צמיגים',
    ],
  },
  {
    nameHe: 'שירותים לבית ומשפחה',
    professions: [
      'עוזר/ת בית', 'מנקה', 'חברת ניקיון', 'מטפל/ת בקשישים',
      'סיוע סיעודי', 'גהוץ ביתי', 'מארגנ/ת בית', 'גנן/ית גינה ביתית',
      'מדביר/ה', 'מובילי דירות', 'טכנאי/ת מוצרי חשמל',
      'טכנאי/ת מחשבים', 'טכנאי/ת רהיטים',
    ],
  },
  {
    nameHe: 'אחר',
    professions: [
      'עצמאי/ת', 'בעל/ת עסק', 'יזם/ית', 'פנסיונר/ית', 'סטודנט/ית',
      'מחפש/ת עבודה', 'בית/אם בית', 'מתנדב/ת', 'אדמיניסטרטור/ית',
      'רכז/ת', 'עוזר/ת אישי/ת',
    ],
  },
];
...
async function seedProfessions() {
  console.log('\nשותל קטגוריות מקצוע ומקצועות...');
  let categoryCount = 0;
  let professionCount = 0;

  for (let i = 0; i < PROFESSION_CATEGORIES.length; i++) {
    const catData = PROFESSION_CATEGORIES[i];
    const sortOrder = (i + 1) * 10;

    const category = await prisma.professionCategory.upsert({
      where: { nameHe: catData.nameHe },
      update: { sortOrder },
      create: { nameHe: catData.nameHe, sortOrder },
    });
    categoryCount++;

    for (let j = 0; j < catData.professions.length; j++) {
      const nameHe = catData.professions[j];
      await prisma.profession.upsert({
        where: { categoryId_nameHe: { categoryId: category.id, nameHe } },
        update: { sortOrder: (j + 1) * 10 },
        create: { categoryId: category.id, nameHe, sortOrder: (j + 1) * 10 },
      });
      professionCount++;
    }
  }
  ...
  console.log(`  מקצועות: ${professionCount}`);
  return { categoryCount, professionCount };
}
...
async function main() {
  ...
  // שתילת קטגוריות מקצוע ומקצועות (idempotent — upsert)
  const { categoryCount, professionCount } = await seedProfessions();
  ...
  console.log('');
  console.log(`  קטגוריות מקצוע: ${categoryCount}`);
  console.log(`  מקצועות סה"כ: ${professionCount}`);
}
