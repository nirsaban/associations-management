  ...
  if (status === 'done') {
    return (
      <div className="space-y-6 text-center">
        <div className="w-16 h-16 mx-auto bg-success/15 rounded-full flex items-center justify-center">
  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        <div className="w-16 h-16 mx-auto bg-primary-soft rounded-full flex items-center justify-center mb-4">
